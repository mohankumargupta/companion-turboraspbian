...
<div class="contentWrapper">
    <div class="wizard">
        <a class="current"><span class="badge">1</span>Welcome</a>
        <a><span class="badge">2</span>Download from Github</a>
        <a><span class="badge badge-inverse">3</span>Setup complete</a>
    </div>
